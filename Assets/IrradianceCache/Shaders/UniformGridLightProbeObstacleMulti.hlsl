#ifndef UNIFORM_GRID_LIGHT_PROBE_OBSTACLE_MULTI_INCLUDED
#define UNIFORM_GRID_LIGHT_PROBE_OBSTACLE_MULTI_INCLUDED

// ============================================================================
// UniformGridLightProbeObstacleMulti.hlsl
// 均匀网格 Light Probe 多 Volume 支持 + OBB 障碍物遮挡
// 函数签名与 UniformGridLightProbeMulti.hlsl 保持一致，可直接替换
// ============================================================================

#include "LightProbeGlobalData.hlsl"
#include "UniformGridLightProbeObstacle.hlsl"
...
// ----------------------------------------------------------------------------
// 多 Volume SH 采样（+ 障碍物遮挡）
// ----------------------------------------------------------------------------

// 从指定 Volume 采样光照颜色（带障碍物遮挡）
...
#endif // UNIFORM_GRID_LIGHT_PROBE_OBSTACLE_MULTI_INCLUDED
